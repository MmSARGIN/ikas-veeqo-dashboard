<template>
  <div>
    ...
    <div>
      <label for="inp" class="text-2xl font-semibold text-gray-500">
        İKAS SECRET KEY
      <input id="inp" class="mt-2 w-full h-16 border-2 text-gray-700 border-gray-500 rounded-tr-3xl rounded-bl-3xl focus:outline-indigo-600 px-5 text-3xl" type="text">
    </label>
    </div>
  
    
    <div class="flex justify-end mt-8">
      <button class="flex items-center justify-between bg-indigo-600 px-10 shadow-xl py-4 border text-2xl text-white rounded-tr-3xl rounded-bl-3xl hover:bg-indigo-700">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="4" stroke="currentColor" class="w-6 h-6 mr-4">
