<template>
    ...
    >
      <div class="flex items-center justify-center">
        <div class="flex items-center">
         <img src="https://cdn.myikas.com/images/theme-images/11d7a0a4-ca51-4c48-bfde-fa3a4cae3713/image_540.webp" class="h-32 w-32" alt="">

          <!-- <span class="mx-2 text-2xl font-semibold text-white">SIRRI</span> -->
        </div>
      </div>
      ...
      <nav class="mt-10">
        ...
        >
          ...
          <span class="mx-4">CONSTANTS</span>
         </router-link>
         <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'Stocks' ? activeClass : inactiveClass]"
          to="/stocks"
        >
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" />
          ...
          <span class="mx-4">UPDATE STOCKS</span>
        </router-link>
<!--
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
